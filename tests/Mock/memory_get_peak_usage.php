...
/**
 * Helper for namespace-level function mock of memory_get_peak_usage.
 *
 ...
 */
final class MemoryGetPeakUsageMock
{
    /**
     ...
     * If null, the real global \memory_get_peak_usage() will be used.
     */
...
/**
 * Mockable version of memory_get_peak_usage.
 */
function memory_get_peak_usage(bool $real_usage = false): int
{
    return MemoryGetPeakUsageMock::handle($real_usage);
}
